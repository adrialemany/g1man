...
class Metaclass_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from unitree_api.msg import ResponseHeader
...
class Response(metaclass=Metaclass_Response):
    ...
    _fields_and_field_types = {
        'header': 'unitree_api/ResponseHeader',
        'data': 'string',
        'binary': 'sequence<int8>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unitree_api', 'msg'], 'ResponseHeader'),  # noqa: E501
    ...
    def binary(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'binary' field must be a set or sequence and each value of type 'int' and each integer in [-128, 127]"
