...
// IWYU pragma: private, include "unitree_go/msg/go2_front_video_data.h"


#ifndef UNITREE_GO__MSG__DETAIL__GO2_FRONT_VIDEO_DATA__FUNCTIONS_H_
#define UNITREE_GO__MSG__DETAIL__GO2_FRONT_VIDEO_DATA__FUNCTIONS_H_
 ...
 * calls
 * unitree_go__msg__Go2FrontVideoData__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__Go2FrontVideoData *
unitree_go__msg__Go2FrontVideoData__create(void);

/// Destroy msg/Go2FrontVideoData message.
/**
 * It calls
 * unitree_go__msg__Go2FrontVideoData__fini()
 ...
 * unitree_go__msg__Go2FrontVideoData__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_go__msg__Go2FrontVideoData__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_GO__MSG__DETAIL__GO2_FRONT_VIDEO_DATA__FUNCTIONS_H_
