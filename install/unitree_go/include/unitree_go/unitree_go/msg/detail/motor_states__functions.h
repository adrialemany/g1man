...
// IWYU pragma: private, include "unitree_go/msg/motor_states.h"


#ifndef UNITREE_GO__MSG__DETAIL__MOTOR_STATES__FUNCTIONS_H_
#define UNITREE_GO__MSG__DETAIL__MOTOR_STATES__FUNCTIONS_H_
 ...
 * calls
 * unitree_go__msg__MotorStates__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__MotorStates *
unitree_go__msg__MotorStates__create(void);

/// Destroy msg/MotorStates message.
/**
 * It calls
 * unitree_go__msg__MotorStates__fini()
 ...
 * unitree_go__msg__MotorStates__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_go__msg__MotorStates__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_GO__MSG__DETAIL__MOTOR_STATES__FUNCTIONS_H_
