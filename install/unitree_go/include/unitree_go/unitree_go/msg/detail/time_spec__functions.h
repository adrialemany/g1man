...
// IWYU pragma: private, include "unitree_go/msg/time_spec.h"


#ifndef UNITREE_GO__MSG__DETAIL__TIME_SPEC__FUNCTIONS_H_
...
/// Initialize msg/TimeSpec message.
/**
...
/// Create msg/TimeSpec message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * unitree_go__msg__TimeSpec__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__TimeSpec *
unitree_go__msg__TimeSpec__create(void);

/// Destroy msg/TimeSpec message.
/**
 * It calls
 * unitree_go__msg__TimeSpec__fini()
...
/// Check for msg/TimeSpec message equality.
/**
...
/// Initialize array of msg/TimeSpec messages.
/**
...
/// Finalize array of msg/TimeSpec messages.
/**
 * It calls
 * unitree_go__msg__TimeSpec__fini()
...
/// Create array of msg/TimeSpec messages.
/**
 * It allocates the memory for the array and calls
 * unitree_go__msg__TimeSpec__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/TimeSpec messages.
/**
 * It calls
 * unitree_go__msg__TimeSpec__Sequence__fini()
 * on the array,
...
/// Check for msg/TimeSpec message array equality.
/**
...
/// Copy an array of msg/TimeSpec messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // UNITREE_GO__MSG__DETAIL__TIME_SPEC__FUNCTIONS_H_
