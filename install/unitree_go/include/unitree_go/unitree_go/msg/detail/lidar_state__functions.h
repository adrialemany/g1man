...
// IWYU pragma: private, include "unitree_go/msg/lidar_state.h"


#ifndef UNITREE_GO__MSG__DETAIL__LIDAR_STATE__FUNCTIONS_H_
...
/// Initialize msg/LidarState message.
/**
...
/// Finalize msg/LidarState message.
/**
...
/// Create msg/LidarState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * unitree_go__msg__LidarState__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__LidarState *
unitree_go__msg__LidarState__create(void);

/// Destroy msg/LidarState message.
/**
 * It calls
 * unitree_go__msg__LidarState__fini()
...
/// Check for msg/LidarState message equality.
/**
...
/// Initialize array of msg/LidarState messages.
/**
...
/// Finalize array of msg/LidarState messages.
/**
 * It calls
 * unitree_go__msg__LidarState__fini()
...
/// Create array of msg/LidarState messages.
/**
 * It allocates the memory for the array and calls
 * unitree_go__msg__LidarState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/LidarState messages.
/**
 * It calls
 * unitree_go__msg__LidarState__Sequence__fini()
 * on the array,
...
/// Check for msg/LidarState message array equality.
/**
...
/// Copy an array of msg/LidarState messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // UNITREE_GO__MSG__DETAIL__LIDAR_STATE__FUNCTIONS_H_
