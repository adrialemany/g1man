...
class MotorCmds(metaclass=Metaclass_MotorCmds):
    ...
    _fields_and_field_types = {
        'cmds': 'sequence<unitree_go/MotorCmd>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['unitree_go', 'msg'], 'MotorCmd')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'cmds' field must be a set or sequence and each value of type 'MotorCmd'"
        self._cmds = value
