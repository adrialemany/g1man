#!/usr/bin/env python3
"""
nav2_cmd_vel_bridge.py
======================
Puente entre Nav2 (ROS 2) y el simulador G1.

Suscribe:
    /cmd_vel  (geometry_msgs/Twist)  — velocidades de Nav2 controller
...
Uso:
    python3 nav2_cmd_vel_bridge.py

    # Asegúrate de tener arrancado:
    #   - run_sim_ai_g1.py (escucha en TCP 6000)
    #   - El bridge mujoco_ros2_lidar_bridge.py
...
class Nav2CmdVelBridge(Node):
    ...
    def __init__(self):
        super().__init__("nav2_cmd_vel_bridge")
