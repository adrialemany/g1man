...
bool cdr_serialize_unitree_go__msg__LidarState(
  const unitree_go__msg__LidarState * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
bool cdr_deserialize_unitree_go__msg__LidarState(
  eprosima::fastcdr::Cdr & cdr,
  unitree_go__msg__LidarState * ros_message)
{
  // Field name: stamp
  {
    cdr >> ros_message->stamp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
bool cdr_serialize_key_unitree_go__msg__LidarState(
  const unitree_go__msg__LidarState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: stamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
size_t get_serialized_size_key_unitree_go__msg__LidarState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LidarState__ros_msg_type * ros_message = static_cast<const _LidarState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
size_t max_serialized_size_key_unitree_go__msg__LidarState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unitree_go__msg__LidarState * ros_message = static_cast<const unitree_go__msg__LidarState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unitree_go__msg__LidarState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unitree_go__msg__LidarState * ros_message = static_cast<unitree_go__msg__LidarState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unitree_go__msg__LidarState(cdr, ros_message);
}
