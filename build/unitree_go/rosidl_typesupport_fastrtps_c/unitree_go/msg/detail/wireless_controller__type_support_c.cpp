...
bool cdr_serialize_unitree_go__msg__WirelessController(
  const unitree_go__msg__WirelessController * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
bool cdr_deserialize_unitree_go__msg__WirelessController(
  eprosima::fastcdr::Cdr & cdr,
  unitree_go__msg__WirelessController * ros_message)
{
  // Field name: lx
  {
    cdr >> ros_message->lx;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
bool cdr_serialize_key_unitree_go__msg__WirelessController(
  const unitree_go__msg__WirelessController * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: lx
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
size_t get_serialized_size_key_unitree_go__msg__WirelessController(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WirelessController__ros_msg_type * ros_message = static_cast<const _WirelessController__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
size_t max_serialized_size_key_unitree_go__msg__WirelessController(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unitree_go__msg__WirelessController * ros_message = static_cast<const unitree_go__msg__WirelessController *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unitree_go__msg__WirelessController(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unitree_go__msg__WirelessController * ros_message = static_cast<unitree_go__msg__WirelessController *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unitree_go__msg__WirelessController(cdr, ros_message);
}
