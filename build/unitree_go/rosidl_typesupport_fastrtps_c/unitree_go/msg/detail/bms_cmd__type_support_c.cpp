...
#include "unitree_go/msg/detail/bms_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _BmsCmd__ros_msg_type = unitree_go__msg__BmsCmd;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_go__msg__BmsCmd;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unitree_go__msg__BmsCmd * ros_message = static_cast<const unitree_go__msg__BmsCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unitree_go__msg__BmsCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unitree_go__msg__BmsCmd * ros_message = static_cast<unitree_go__msg__BmsCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unitree_go__msg__BmsCmd(cdr, ros_message);
}

static uint32_t _BmsCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_go__msg__BmsCmd(
...
static size_t _BmsCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_go__msg__BmsCmd(
