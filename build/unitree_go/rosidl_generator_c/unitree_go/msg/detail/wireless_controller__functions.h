...
// IWYU pragma: private, include "unitree_go/msg/wireless_controller.h"


#ifndef UNITREE_GO__MSG__DETAIL__WIRELESS_CONTROLLER__FUNCTIONS_H_
 ...
 * calls
 * unitree_go__msg__WirelessController__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__WirelessController *
unitree_go__msg__WirelessController__create(void);

/// Destroy msg/WirelessController message.
/**
 * It calls
 * unitree_go__msg__WirelessController__fini()
 ...
 * unitree_go__msg__WirelessController__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_go__msg__WirelessController__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_GO__MSG__DETAIL__WIRELESS_CONTROLLER__FUNCTIONS_H_
