...
// IWYU pragma: private, include "unitree_go/msg/req.h"


#ifndef UNITREE_GO__MSG__DETAIL__REQ__FUNCTIONS_H_
#define UNITREE_GO__MSG__DETAIL__REQ__FUNCTIONS_H_
...
/// Create msg/Req message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * unitree_go__msg__Req__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__Req *
unitree_go__msg__Req__create(void);

/// Destroy msg/Req message.
/**
 * It calls
 * unitree_go__msg__Req__fini()
...
/// Check for msg/Req message equality.
/**
...
/// Initialize array of msg/Req messages.
/**
...
/// Finalize array of msg/Req messages.
/**
 * It calls
 * unitree_go__msg__Req__fini()
...
/// Create array of msg/Req messages.
/**
 * It allocates the memory for the array and calls
 * unitree_go__msg__Req__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/Req messages.
/**
 * It calls
 * unitree_go__msg__Req__Sequence__fini()
 * on the array,
...
/// Check for msg/Req message array equality.
/**
...
/// Copy an array of msg/Req messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // UNITREE_GO__MSG__DETAIL__REQ__FUNCTIONS_H_
