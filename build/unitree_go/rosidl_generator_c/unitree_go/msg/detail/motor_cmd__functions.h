...
// IWYU pragma: private, include "unitree_go/msg/motor_cmd.h"


#ifndef UNITREE_GO__MSG__DETAIL__MOTOR_CMD__FUNCTIONS_H_
#define UNITREE_GO__MSG__DETAIL__MOTOR_CMD__FUNCTIONS_H_
 ...
 * calls
 * unitree_go__msg__MotorCmd__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_go
unitree_go__msg__MotorCmd *
unitree_go__msg__MotorCmd__create(void);

/// Destroy msg/MotorCmd message.
/**
 * It calls
 * unitree_go__msg__MotorCmd__fini()
 ...
 * unitree_go__msg__MotorCmd__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_go__msg__MotorCmd__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_GO__MSG__DETAIL__MOTOR_CMD__FUNCTIONS_H_
