...
#include "unitree_go/msg/detail/interface_config__type_support.h"
...
static const _InterfaceConfig_type_support_symbol_names_t _InterfaceConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_go, msg, InterfaceConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_go, msg, InterfaceConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unitree_go, msg, InterfaceConfig)() {
  return &::unitree_go::msg::rosidl_typesupport_c::InterfaceConfig_message_type_support_handle;
}
