...
{
  new (message_memory) unitree_go::msg::PathPoint(_init);
}

void PathPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_go::msg::PathPoint *>(message_memory);
  typed_message->~PathPoint();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember PathPoint_message_member_array[7] = {
  {
    "t_from_start",  // name
    ...
    offsetof(unitree_go::msg::PathPoint, t_from_start),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::PathPoint, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::PathPoint, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::PathPoint, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::PathPoint, vx),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::PathPoint, vy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::PathPoint, vyaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathPoint_message_members = {
  ...
  7,  // number of fields
  sizeof(unitree_go::msg::PathPoint),
...
{
  return &::unitree_go::msg::rosidl_typesupport_introspection_cpp::PathPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_go, msg, PathPoint)() {
  return &::unitree_go::msg::rosidl_typesupport_introspection_cpp::PathPoint_message_type_support_handle;
}
