...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_BmsState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: imu_state
  unitree_go::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.imu_state,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: imu_state
  current_alignment +=
    unitree_go::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.imu_state, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: imu_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_go::msg::typesupport_fastrtps_cpp::max_serialized_size_key_IMUState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_go::msg::typesupport_fastrtps_cpp::max_serialized_size_key_MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: bms_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_go::msg::typesupport_fastrtps_cpp::max_serialized_size_key_BmsState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
