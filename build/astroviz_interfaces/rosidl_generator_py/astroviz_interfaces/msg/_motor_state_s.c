...
bool astroviz_interfaces__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("astroviz_interfaces.msg._motor_state.MotorState", full_classname_dest, 47) == 0);
  }
  astroviz_interfaces__msg__MotorState * ros_message = _ros_message;
  {  // name
...
PyObject * astroviz_interfaces__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("astroviz_interfaces.msg._motor_state");
