...
#include "astroviz_interfaces/msg/detail/motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _MotorState__ros_msg_type = astroviz_interfaces__msg__MotorState;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = astroviz_interfaces__msg__MotorState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const astroviz_interfaces__msg__MotorState * ros_message = static_cast<const astroviz_interfaces__msg__MotorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_astroviz_interfaces__msg__MotorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  astroviz_interfaces__msg__MotorState * ros_message = static_cast<astroviz_interfaces__msg__MotorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_astroviz_interfaces__msg__MotorState(cdr, ros_message);
}

static uint32_t _MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_astroviz_interfaces__msg__MotorState(
...
static size_t _MotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_astroviz_interfaces__msg__MotorState(
