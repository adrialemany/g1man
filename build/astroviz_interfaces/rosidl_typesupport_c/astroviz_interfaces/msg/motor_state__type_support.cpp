...
static const _MotorState_type_support_symbol_names_t _MotorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, astroviz_interfaces, msg, MotorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astroviz_interfaces, msg, MotorState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, astroviz_interfaces, msg, MotorState)() {
  return &::astroviz_interfaces::msg::rosidl_typesupport_c::MotorState_message_type_support_handle;
}
