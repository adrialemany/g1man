  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unitree_api__msg__RequestIdentity * ros_message = static_cast<const unitree_api__msg__RequestIdentity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unitree_api__msg__RequestIdentity(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unitree_api__msg__RequestIdentity * ros_message = static_cast<unitree_api__msg__RequestIdentity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unitree_api__msg__RequestIdentity(cdr, ros_message);
}
