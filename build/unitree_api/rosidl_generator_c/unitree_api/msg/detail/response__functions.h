...
// IWYU pragma: private, include "unitree_api/msg/response.h"


#ifndef UNITREE_API__MSG__DETAIL__RESPONSE__FUNCTIONS_H_
#define UNITREE_API__MSG__DETAIL__RESPONSE__FUNCTIONS_H_
 ...
 * calls
 * unitree_api__msg__Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_api
unitree_api__msg__Response *
unitree_api__msg__Response__create(void);

/// Destroy msg/Response message.
/**
 * It calls
 * unitree_api__msg__Response__fini()
 ...
 * unitree_api__msg__Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_api__msg__Response__Sequence__fini()
 * on the array,
...
#endif  // UNITREE_API__MSG__DETAIL__RESPONSE__FUNCTIONS_H_
