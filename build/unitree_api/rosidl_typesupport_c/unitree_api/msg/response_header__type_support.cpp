...
#include "unitree_api/msg/detail/response_header__type_support.h"
...
static const _ResponseHeader_type_support_symbol_names_t _ResponseHeader_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_api, msg, ResponseHeader)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_api, msg, ResponseHeader)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unitree_api, msg, ResponseHeader)() {
  return &::unitree_api::msg::rosidl_typesupport_c::ResponseHeader_message_type_support_handle;
}
