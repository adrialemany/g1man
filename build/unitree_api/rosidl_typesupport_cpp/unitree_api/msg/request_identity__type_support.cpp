...
static const _RequestIdentity_type_support_symbol_names_t _RequestIdentity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_api, msg, RequestIdentity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_api, msg, RequestIdentity)),
  }
};
...
{
  return &::unitree_api::msg::rosidl_typesupport_cpp::RequestIdentity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unitree_api, msg, RequestIdentity)() {
  return get_message_type_support_handle<unitree_api::msg::RequestIdentity>();
}
