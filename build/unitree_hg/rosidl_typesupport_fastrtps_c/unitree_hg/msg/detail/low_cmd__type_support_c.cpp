...
bool cdr_serialize_unitree_hg__msg__LowCmd(
  const unitree_hg__msg__LowCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mode_pr
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_hg
bool cdr_deserialize_unitree_hg__msg__LowCmd(
  eprosima::fastcdr::Cdr & cdr,
  unitree_hg__msg__LowCmd * ros_message)
{
  // Field name: mode_pr
  {
    cdr >> ros_message->mode_pr;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_hg
bool cdr_serialize_key_unitree_hg__msg__LowCmd(
  const unitree_hg__msg__LowCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mode_pr
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_hg
size_t get_serialized_size_key_unitree_hg__msg__LowCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowCmd__ros_msg_type * ros_message = static_cast<const _LowCmd__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_hg
size_t max_serialized_size_key_unitree_hg__msg__LowCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unitree_hg__msg__LowCmd * ros_message = static_cast<const unitree_hg__msg__LowCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unitree_hg__msg__LowCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unitree_hg__msg__LowCmd * ros_message = static_cast<unitree_hg__msg__LowCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unitree_hg__msg__LowCmd(cdr, ros_message);
}
