  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unitree_hg__msg__PressSensorState * ros_message = static_cast<const unitree_hg__msg__PressSensorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unitree_hg__msg__PressSensorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unitree_hg__msg__PressSensorState * ros_message = static_cast<unitree_hg__msg__PressSensorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unitree_hg__msg__PressSensorState(cdr, ros_message);
}
