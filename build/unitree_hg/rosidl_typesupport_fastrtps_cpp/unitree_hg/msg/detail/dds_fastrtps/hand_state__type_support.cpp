...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_PressSensorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: motor_state
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      unitree_hg::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.motor_state[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        unitree_hg::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.motor_state[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_hg::msg::typesupport_fastrtps_cpp::max_serialized_size_key_MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: press_sensor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_hg::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PressSensorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: imu_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_hg::msg::typesupport_fastrtps_cpp::max_serialized_size_key_IMUState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
